## **TabNine For Monaco Editor**

**This repository is a placeholder, used to gauge the level of interest of Monaco Editor users in a TabNine extension.**

### **TabNine Overview:**

---

This is the Monaco Editor [TabNine](https://codota.com) client, advanced AI based autocomplete for all programming languages. TabNine Indexes your entire project by reading your `.gitignore` [or others](https://www.tabnine.com/faq#nongit), and determines which files to index.
